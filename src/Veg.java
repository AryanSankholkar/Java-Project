...
public class Veg {
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("Veg Diet Plan");
		lblNewLabel.setForeground(Color.DARK_GRAY);
		lblNewLabel.setFont(new Font("Baskerville Old Face", Font.BOLD, 24));
		lblNewLabel.setBounds(10, 11, 142, 24);
		...
		JLabel lblNewLabel_1_2_3 = new JLabel("Paneer/Soya Sabji ");
		...
		JLabel lblNewLabel_1_2_7 = new JLabel("Khichdi with Sprout Salad");
		...
		JLabel lblNewLabel_1_2_8 = new JLabel("Mix Vegetable Soup");
